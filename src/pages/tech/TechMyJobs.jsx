              ...
              {isActive && !completedJob && (
                <div className="space-y-2 pt-3 border-t border-white/8">
                  <button
                    ...
                    className={`w-full flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-semibold transition-all ${uploadedJob === job.id ? 'bg-emerald-500/20 text-emerald-400 border border-emerald-500/20' : 'bg-surface-800 text-surface-300 hover:bg-surface-700 border border-white/8'}`}
                  >
