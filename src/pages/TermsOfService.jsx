...
const COMPANY = 'MatcHvac, LLC'
const COMPANY_STATE = 'Maryland'
const CONTACT_EMAIL = 'legal@matchvac.com'
  ...
  return (
    <div className="space-y-3">
      <Section title="1. Agreement to Terms" defaultOpen>
        <P>By accessing or using the MatcHvac platform ("Platform"), website, or mobile application, you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not access or use the Platform.</P>
        <P>These Terms constitute a legally binding agreement between you and {COMPANY}, a {COMPANY_STATE}-registered limited liability company ("MatcHvac," "we," "us," or "our"). {COMPANY} operates as a technology marketplace that connects customers seeking home services with independent service providers.</P>
      ...
      <Section title="2. Nature of the Platform — We Are a Marketplace">
        <Highlight>MatcHvac is a technology platform that facilitates connections between customers and independent contractors. We are NOT a home services company, employer, or general contractor. All services are performed by independent third-party professionals who are not employees, agents, or representatives of MatcHvac.</Highlight>
        <P>MatcHvac does not perform, supervise, direct, or control any home services work. The service providers on the Platform are solely responsible for the quality, safety, legality, and timeliness of the services they provide.</P>
        <P>This relationship is similar to that of other marketplace platforms. Your agreement to receive services is directly with the independent service provider, not with MatcHvac.</P>
      </Section>
      ...
      <Section title="4. Account Registration & Security">
        <P>You are responsible for maintaining the confidentiality of your account credentials and for all activity that occurs under your account. You agree to notify MatcHvac immediately at {CONTACT_EMAIL} of any unauthorized use of your account.</P>
        <P>MatcHvac reserves the right to suspend or terminate accounts at any time for violations of these Terms or for conduct that MatcHvac, in its sole discretion, deems harmful to the Platform or its users.</P>
      </Section>
      ...
      <Section title="8. Limitation of Liability">
        ...
        <P>MatcHvac's total aggregate liability to you for any and all claims arising from or relating to the Platform shall not exceed the greater of (a) the total fees paid by you to MatcHvac in the twelve (12) months preceding the claim, or (b) one hundred dollars ($100.00).</P>
      ...
      <Section title="9. Indemnification">
        <P>You agree to defend, indemnify, and hold harmless MatcHvac and its officers, directors, employees, affiliates, agents, licensors, and service providers from and against any claims, liabilities, damages, judgments, awards, losses, costs, expenses, or fees (including reasonable attorneys' fees) arising out of or relating to your violation of these Terms or your use of the Platform.</P>
      </Section>
  ...
  return (
    <div className="space-y-3">
      <Section title="C-1. Service Booking & the Marketplace" defaultOpen>
        <P>When you submit a service request through MatcHvac, you are posting a job to our marketplace. MatcHvac broadcasts your request to independent, licensed service providers in your area. Acceptance of your job by a provider creates a direct service agreement between you and that provider — not between you and MatcHvac.</P>
        <P>MatcHvac makes no guarantee that a provider will accept your request, that work will be completed by a specific time, or that any specific provider will be available. Job acceptance and fulfillment are at the discretion of the independent provider.</P>
      </Section>
      ...
      <Section title="C-3. Escrow Payment & Release">
        <Highlight>MatcHvac operates an escrow-based payment system. Your payment method is authorized at booking but funds are NOT transferred to the service provider until you confirm job completion. This is your primary protection mechanism.</Highlight>
      ...
      <Section title="C-4. Payment Disputes">
        ...
        <P>To dispute a job, you must do so BEFORE releasing escrow funds. File a dispute through the Track Job screen or by emailing {CONTACT_EMAIL} with your job ID. Once funds are released, MatcHvac cannot guarantee recovery.</P>
        <H>Dispute Resolution Process</H>
        <UL items={[
          'MatcHvac will review submitted evidence from both parties (photos, messages, job description).',
          'We will attempt to mediate a resolution within 5 business days.',
          'If mediation fails, MatcHvac may escalate to independent arbitration per Section 10 of the General Terms.',
          'MatcHvac\'s decision in platform-level disputes is final for matters under $500.',
        ]} />
        <H>Chargebacks</H>
        <P>Initiating a credit card chargeback without first exhausting MatcHvac's dispute process is a violation of these Terms and may result in account suspension. MatcHvac will contest chargebacks where the dispute process was not followed.</P>
      </Section>
      <Section title="C-5. Quality of Work & Satisfaction Guarantee">
        <P>MatcHvac requires all providers to maintain a minimum quality standard and rating. If work is defective, incomplete, or not as described, you must:</P>
        <UL items={[
      ...
      <Section title="C-7. Property Access & Safety">
        <P>By scheduling a service, you represent that you have the legal authority to grant access to the property at which services will be performed. You agree to provide a safe working environment for the service provider and to disclose any known hazards. MatcHvac is not responsible for injuries to providers resulting from undisclosed property hazards.</P>
      </Section>
      <Section title="C-8. Cancellations & No-Shows">
        ...
        <P>If a provider fails to arrive without notice, you may cancel the job at no charge and MatcHvac will attempt to re-dispatch another available provider.</P>
      </Section>
      <Section title="C-9. Off-Platform Solicitation by Providers">
        <Warning>If a service provider solicits you to pay for services outside of the MatcHvac platform — by cash, Venmo, Zelle, or any other payment method not processed through MatcHvac — you should DECLINE and report it immediately to {CONTACT_EMAIL}. Accepting off-platform payment arrangements (a) voids any escrow protections, (b) voids any dispute resolution rights, and (c) may result in the provider's removal from the platform. MatcHvac is not responsible for any services paid for or arranged outside the platform.</Warning>
      </Section>
      <Section title="C-10. Reviews & Ratings">
        <P>You may submit a rating and review after job completion. Reviews must be truthful, based on your genuine experience, and comply with our content guidelines. MatcHvac reserves the right to remove reviews that are fraudulent, defamatory, or in violation of these Terms. Submitting a false negative review to extort a refund or other benefit is a violation of these Terms and may result in account termination.</P>
      </Section>
    </div>
  )
}
  ...
  return (
    <div className="space-y-3">
      <Section title="T-1. Independent Contractor Status" defaultOpen>
        <Highlight>You are an independent contractor, NOT an employee of MatcHvac. Nothing in these Terms or your use of the Platform creates an employment relationship, partnership, joint venture, agency, franchise, or sales representative relationship between you and MatcHvac.</Highlight>
      ...
      <Section title="T-2. Eligibility & Onboarding Requirements">
        <P>To become an approved provider on MatcHvac, you must:</P>
        <UL items={[
        ...
        <P>MatcHvac reserves the right to deny or revoke approval at any time in its sole discretion. Approval does not guarantee a minimum number of jobs or income.</P>
      </Section>
      <Section title="T-3. Background Checks — Limitations & Your Obligations">
        ...
        <P>You are required to notify MatcHvac within 48 hours if you are: arrested, charged, or convicted of any crime; your professional license is suspended, revoked, or placed on probation; your insurance lapses or is cancelled; or any material change occurs that would affect your eligibility.</P>
      ...
      <Section title="T-4. Job Acceptance & Conduct Standards">
        ...
        <UL items={[
          ...
          'Identify yourself by name and show your MatcHvac provider ID upon arrival.',
      ...
      <Section title="T-5. Prohibition on Off-Platform Solicitation — CRITICAL">
        ...
        <UL items={[
          'Soliciting, accepting, or encouraging payment from a customer through any method not processed by MatcHvac (including but not limited to cash, Venmo, Zelle, PayPal, check, or verbal agreement for future work).',
        ...
        <P>Violations may result in: immediate permanent account termination; forfeiture of any pending earnings; civil liability for liquidated damages of $5,000 per violation plus MatcHvac's lost platform fees; and referral to applicable licensing boards.</P>
        <P>By using the Platform, you acknowledge this restriction and agree it is reasonable given MatcHvac's investment in customer acquisition and the reasonable business interests it protects.</P>
      </Section>
      <Section title="T-6. Pricing, Earnings & Fees">
        <H>Platform Fees</H>
        <P>MatcHvac deducts a platform fee from each job based on your subscription tier (Standard: 15%, Pro: 11%, Elite: 8%). The net payout amount is displayed before you claim any job. By claiming a job, you agree to the displayed net payout.</P>
        <H>Payouts</H>
        <P>Payouts are processed via ACH direct deposit following customer payment confirmation or the expiration of the customer's 72-hour confirmation window. MatcHvac is not responsible for bank processing delays. Payout schedules may change with 7 days' notice.</P>
        <H>Disputed Jobs</H>
        <P>If a customer disputes a job, payouts for that job may be held pending resolution. MatcHvac will notify you promptly and give you the opportunity to submit evidence. Do not contact customers directly regarding disputes — all dispute communication must go through MatcHvac.</P>
      </Section>
      <Section title="T-7. Taxes & Tax Reporting">
        <P>You are solely responsible for all tax obligations arising from income earned through the Platform. MatcHvac will issue a Form 1099-NEC for total Platform earnings exceeding $600 in a calendar year. You are responsible for paying all federal, state, and local income taxes, self-employment taxes, and any other applicable taxes.</P>
        <P>MatcHvac strongly recommends consulting a qualified tax professional. The Platform's Tax Center provides estimated quarterly tax calculations as a convenience tool only — these are estimates and not tax advice.</P>
      </Section>
      <Section title="T-8. Customer Property & Liability">
        <P>You are responsible for any damage caused to a customer's property during the performance of services. You must maintain general liability insurance sufficient to cover such claims. MatcHvac is not liable for property damage caused by providers. By accepting a job, you acknowledge sole responsibility for your workmanship and any incidental damage.</P>
        <P>In the event of a property damage claim, you must: notify MatcHvac within 24 hours; document the damage with photos; and cooperate with any insurance claim or dispute process.</P>
      </Section>
      <Section title="T-9. Ratings, Deactivation & Appeals">
        <P>MatcHvac maintains quality standards for all providers. Providers with an average rating below 4.0 over their last 20 jobs, or who accumulate excessive complaints, may be placed on probation or deactivated. You will receive notice and an opportunity to respond before permanent deactivation for conduct violations (except in cases of fraud, safety violations, or off-platform solicitation, which may result in immediate deactivation).</P>
      </Section>
      <Section title="T-10. Safety & Emergency Situations">
        <P>If you encounter a safety emergency at a job site (medical emergency, dangerous conditions, threatening behavior), call 911 immediately, remove yourself from danger, and notify MatcHvac as soon as it is safe to do so. Do not place yourself in danger to complete a job.</P>
      </Section>
    </div>
  )
}
  ...
  return (
    <div className="space-y-3">
      <Section title="B-1. Contractor Program Overview" defaultOpen>
        <P>The MatcHvac Contractor Program allows licensed HVAC contracting businesses ("Contractor Partners") to participate in the MatcHvac marketplace through referral arrangements, co-branded advertising, and lead generation. Participation is subject to approval and execution of a separate Contractor Partner Agreement in addition to these Terms.</P>
      </Section>
      <Section title="B-2. Eligibility Requirements">
        ...
        <UL items={[
          ...
          'Agree to MatcHvac\'s Contractor Code of Conduct.',
      ...
      <Section title="B-3. Subscription Tiers & Fees">
        ...
        <P>MatcHvac reserves the right to modify tier pricing with 30 days' written notice. Continued participation after price changes constitutes acceptance.</P>
      </Section>
      <Section title="B-4. Lead Quality & Referral Terms">
        <P>Leads provided through MatcHvac are generated through customer service requests. MatcHvac makes no guarantee regarding lead quality, conversion rate, or total lead volume. A "converted job" for referral fee purposes means a job completed and paid on the Platform that originated from a referral attributed to your business.</P>
      ...
      <Section title="B-9. Termination">
        <P>Either party may terminate the Contractor Partner Agreement with 30 days' written notice. MatcHvac may terminate immediately for material breach, including but not limited to non-circumvention violations, data misuse, insurance lapses, or loss of business licensure. Upon termination, your listing, ad placements, and referral links will be removed.</P>
      </Section>
    </div>
  )
}
  ...
  return (
    <div className="space-y-3">
      <Section title="L-1. Lending Partner Program Overview" defaultOpen>
        <P>MatcHvac's Lending Partner Program allows licensed financial institutions and registered lenders ("Lending Partners") to offer financing products to MatcHvac customers through the Platform. Participation requires execution of a separate Lending Partner Agreement and compliance with all applicable federal and state lending laws.</P>
      </Section>
      <Section title="L-2. Regulatory Compliance">
        ...
        <P>MatcHvac provides a technology referral channel only and does not make credit decisions, originate loans, service loans, or hold any banking or lending license. MatcHvac is not a creditor, broker, or financial institution as defined under applicable law.</P>
      </Section>
      <Section title="L-3. Referral Arrangement">
        <P>MatcHvac refers interested customers to Lending Partners through in-app placements and marketing. A "referral" occurs when a customer clicks through to the Lending Partner's application interface. MatcHvac receives a referral fee as negotiated in the Lending Partner Agreement only upon successful loan origination. MatcHvac does not receive fees based on loan terms, interest rates, or credit decisions.</P>
        <Highlight>MatcHvac does not influence, direct, or have access to credit decisions made by Lending Partners. All credit decisions are made independently by the Lending Partner in accordance with their underwriting criteria.</Highlight>
      </Section>
      ...
      <Section title="L-5. Customer Data & Privacy">
        <P>Lending Partners may only collect customer data necessary for loan application and servicing purposes. Customer data obtained through the Platform may not be used for cross-selling unrelated financial products without explicit customer consent. All data handling must comply with GLBA, applicable state privacy laws, and MatcHvac's Data Sharing Addendum.</P>
      </Section>
      <Section title="L-6. Indemnification by Lending Partner">
        <P>Lending Partners agree to indemnify and hold harmless MatcHvac from any claims, losses, penalties, or regulatory actions arising from the Lending Partner's lending activities, regulatory non-compliance, or misuse of customer data obtained through the Platform.</P>
      </Section>
      <Section title="L-7. Prohibition on Unauthorized Outreach">
        <P>Lending Partners may not use customer contact information obtained through MatcHvac referrals to market products or services unrelated to the customer's original financing inquiry without the customer's explicit opt-in consent obtained at the time of application.</P>
      </Section>
      <Section title="L-8. Advertising Standards">
        <P>All marketing materials displayed on the Platform must be approved by MatcHvac prior to publication. MatcHvac reserves the right to reject or remove materials that are misleading, non-compliant, or inconsistent with the Platform's brand standards. Lending Partners are responsible for ensuring all disclosures required by applicable law appear in all marketing materials.</P>
      </Section>
    </div>
  )
}
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-surface-400 text-lg max-w-2xl mx-auto leading-relaxed">
            Please read these terms carefully. They govern your use of the MatcHvac platform and vary by your role. Select your category below.
          </p>
        ...
        <div className="flex items-start gap-3 px-4 py-3 bg-white border border-surface-200 rounded-xl mb-6">
          ...
          <p className="text-surface-400 text-sm leading-relaxed">
            ...
            {activeTab === 'contractor' && 'These terms apply to HVAC contracting businesses participating in the MatcHvac Contractor Partner Program.'}
            {activeTab === 'lending' && 'These terms apply to financial institutions and registered lenders participating in the MatcHvac Lending Partner Program.'}
          </p>
        </div>
