    ...
    extend: {
      colors: {
        ...
        surface: {
          ...
          100: withOpacity('#f8f8f7'),
          150: withOpacity('#f1f1ef'),
          200: withOpacity('#e4e4e1'),
          300: withOpacity('#c8c7c2'),
          400: withOpacity('#9e9b95'),
          500: withOpacity('#6e6c67'),
          600: withOpacity('#4a4845'),
          700: withOpacity('#333230'),
          800: withOpacity('#1e1d1b'),
          900: withOpacity('#111110'),
          950: withOpacity('#0a0a09'),
        },
        accent: {
